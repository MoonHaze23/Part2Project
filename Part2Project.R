project <- system.file("extdata", "project.csv", package = "Part2Project")
...
#'
#' @examples
#' linear_regression_and_hypotheses(project, "height", "weight")
...
#'
#' @examples
#' chi_squared_test_gender_activity("project")
